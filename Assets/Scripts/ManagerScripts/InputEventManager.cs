...
public class InputEventManager : MonoBehaviour
{
	...
	public event Action GrapplePerformed;
	public event Action GrappleCanceled;
	public event Action PullPerformed;
	...
	private void OnAimPerformed( InputAction.CallbackContext ctx )          => GrapplePerformed?.Invoke();
	private void OnAimCanceled( InputAction.CallbackContext ctx )           => GrappleCanceled?.Invoke();
	private void OnShootPerformed( InputAction.CallbackContext ctx )        => PullPerformed?.Invoke();
	private void OnShootCanceled( InputAction.CallbackContext ctx )         => PullCanceled?.Invoke();
